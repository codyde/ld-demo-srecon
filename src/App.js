...
function App() {
  ...
  return (
    <div className="App h-screen bg-ldls grid grid-cols-3 grid-rows-3  bg-cover bg-no-repeat">
      {upperimage ? 
      <div className="body grid col-span-3 row-start-1 ;xl:row-start-2 place-items-center">
        {logoversion ? (
      ...
      : <div />}
      <header className="App-header grid row-start-2 xl:row-start-2 col-span-3">
        <Header />
      </header>
